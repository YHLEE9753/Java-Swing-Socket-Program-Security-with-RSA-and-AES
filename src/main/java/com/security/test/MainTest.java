...
import com.security.socket.file.FileReceiver;
import com.security.socket.file.FileSender;
...
//            System.out.println(encryptAES);
            ...
            clientService.sendAESKeyToServer(encryptAES);
...
//            System.out.println(clientAESKey);
            ...
            String AESFromClient = serverService.checkEncryptedAES();
            System.out.println(AESFromClient);
            String serverAESKey = RSAUtil.decryptRSA(AESFromClient, privateKey);
